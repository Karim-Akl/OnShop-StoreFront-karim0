...
const PageHeader: React.FC<HeaderProps> = ({
  ...
  return (
    ...
    >
      {/* <div className="absolute top-0 ltr:left-0 rtl:right-0 w-full h-full opacity-50 transition-opacity duration-500 group-hover:opacity-80" /> */}
      <div className="w-full flex items-center justify-center relative z-10 ">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center" style={{color:'black'}}>
          {/* <span className="font-satisfy block font-normal mb-3">
            {t(`${pageSubHeader}`)}
          </span> */}
          {t(`${pageHeader}`)}
